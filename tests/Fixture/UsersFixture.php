...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_users_enderecos' => ['type' => 'index', 'columns' => ['endereco_id'], 'length' => []],
            'fk_users_grupos' => ['type' => 'index', 'columns' => ['grupo_id'], 'length' => []],
            'fk_users_status' => ['type' => 'index', 'columns' => ['status_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_users_enderecos' => ['type' => 'foreign', 'columns' => ['endereco_id'], 'references' => ['enderecos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'grupo_id' => 1,
                'status_id' => 1,
                'created' => '2018-10-06 15:22:27',
                'modified' => '2018-10-06 15:22:27'
            ],
        ];
        parent::init();
    }
